...
@pytest.mark.asyncio
async def test_verify_phone_to_regist_user_1(session, async_app_client, post_body_verify_phone_to_regist_user_1):
...
@pytest.mark.asyncio
async def test_regist_user_1(session, async_app_client, post_body_verify_phone_to_regist_user_1, post_body_regist_user_1):
...
@pytest.mark.asyncio
async def test_verify_phone_to_reset_user_1(logger, session, async_app_client, post_body_verify_phone_to_regist_user_1, post_body_regist_user_1, user_class):
    response_jwt = await async_app_client.post(url=api_auth_verify_phone_to_regist, json=post_body_verify_phone_to_regist_user_1)
