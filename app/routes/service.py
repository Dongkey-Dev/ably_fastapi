...
from app.models import UsersAllOut, UserServiceOut
...
@router.get("/me", response_model=UserServiceOut, dependencies=[Depends(auth_scheme)])
async def read_users_me(user_info: UserServiceOut = Depends(get_user_token)):
    return user_info
